...
#include "7zip/Archive/7z/7zEncode.h"
#include "7zip/Archive/7z/7zFolderInStream.h"
...
// ======================== Duny ========================
static const UInt64 k_MP3  = 0x3F44756E792E0001;
...
static void MakeMp3Method (const CCompressionMethodMode &method, CCompressionMethodMode &mp3Method)
{
    CMethodFull methodFull;
    ...
    GetMethodFull (k_LZMA, 1, methodFull);
	DECLARE_PROPERTY (prop);
	ADD_PROPERTY (methodFull, prop, NCoderPropID::kAlgorithm, kAlgorithmForHeaders);
	ADD_PROPERTY (methodFull, prop, NCoderPropID::kMatchFinder, kLzmaMatchFinderForHeaders);
	ADD_PROPERTY (methodFull, prop, NCoderPropID::kDictionarySize, kDictionaryForHeaders);
    ADD_PROPERTY (methodFull, prop, NCoderPropID::kNumFastBytes, kNumFastBytesForHeaders);
    ADD_PROPERTY (methodFull, prop, NCoderPropID::kNumThreads, (UInt32)1);

    mp3Method.Methods.Add (methodFull); // headers stream codec
    mp3Method.Methods.Add (methodFull); // side info stream codec
